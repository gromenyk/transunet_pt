...
wandb.init(project="deeppatella", entity="deeppatella", group = 'training', name='train_experiment_10')
...
def trainer_synapse(args, model, snapshot_path):
    ...
    db_train = Synapse_dataset(base_dir=args.root_path, list_dir=args.list_dir, split="train",
                               transform=None) #transforms.Compose([RandomGenerator(output_size=[args.img_size, args.img_size])]))
    ...
    optimizer = optim.Adam(model.parameters(), lr=base_lr, weight_decay=0.0001) #, momentum=0.95
